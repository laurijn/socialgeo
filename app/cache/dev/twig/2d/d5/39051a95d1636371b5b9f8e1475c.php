...
class __TwigTemplate_2dd539051a95d1636371b5b9f8e1475c extends Twig_Template
{
...
";
    ...
    public function block_panel($context, array $blocks = array())
    {
        ...
        if (("explain" == (isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")))) {
            // line 44
            echo "        ";
            echo $this->env->getExtension('actions')->renderAction($this->env->getExtension('routing')->getUrl("_profiler_doctrine", array("token" => (isset($context["token"]) ? $context["token"] : $this->getContext($context, "token")), "panel" => "db", "connectionName" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request"), "query"), "get", array(0 => "connection"), "method"), "query" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request"), "query"), "get", array(0 => "query"), "method"))), array(), array());
            // line 50
            echo "    ";
        } else {
            // line 51
